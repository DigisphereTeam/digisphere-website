      ...
      <div className="row gy-2">
        ...
        <div className="col-12">
          <div className="blogs-article-card d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center ">
              ...
              <div>
                <span className="blogs-card-tag d-block">WEB DEV</span>
                <h3 className="blogs-card-title m-0">Why websites fail to generate leads</h3>
              </div>
            </div>
        ...
        <div className="col-12">
          <div className="blogs-article-card d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center ">
              ...
              <div>
                <span className="blogs-card-tag d-block">AI & AUTOMATION</span>
                <h3 className="blogs-card-title m-0">Practical AI for Indian SMEs in 2026</h3>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center ">
             ...
             <img src={webook} alt="webook"/>
              ...
              <div>
                ...
                <h3 className="blogs-card-title m-0">Cut your AWS bill by 42%</h3>
              </div>
            </div>
        ...
        <div className="col-12">
          <div className="blogs-subscribe-banner d-flex align-items-center justify-content-between">
            <div>
              <h4 className="blogs-banner-title m-0">Weekly Digest</h4>
              <p className="blogs-banner-subtitle m-0">New articles every Tuesday</p>
            </div>
            <button className="blogs-btn-subscribe border-0">
              Subscribe <span className="ms-1"><FaArrowRight/></span>
            </button>
          </div>
        </div>
