...
const caseStudiesData = [
...

  {
    ...
    title: "Logistics",
    path: "/casestudieslogistics",

    challenge:
      "A 120-truck fleet company running on disconnected WhatsApp groups and Excel sheets had zero real-time visibility into fleet location and delivery status.",
              ...
              >
                <Reveal variant={fadeUp} delay={0.2}>
                  ...
                  <Link to={item.path} className="text-decoration-none">
                    <button
                      type="button"
                      className="btn btn-outline-secondary project-start-btn"
                    >
