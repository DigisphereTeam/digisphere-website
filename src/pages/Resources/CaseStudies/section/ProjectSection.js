...
const caseStudiesData = [
  {
    ...
    challenge: 'Patient appointment scheduling was handled entirely by phone — staff spent 4+ hours daily managing calls and the no-show rate was 24%.',
    solution: 'Built a patient portal with online appointment booking, automated SMS reminders, and WhatsApp confirmations. Integrated with their existing HIS.',
    stats: [
  ...
  },
  {
    ...
    challenge: 'A 40-year-old textile business relying entirely on offline sales wanted to expand online but had no digital presence or technical team.',
    solution: 'Built a product catalogue website, integrated with WhatsApp ordering, and set up automated inventory alerts and order fulfillment notifications.',
    stats: [
  ...
  },
  {
    ...
    title: 'Real Ventures',
    challenge: 'A mid-size property developer with 800+ leads per month had no CRM — leads were managed in spreadsheets, follow-up was inconsistent, and conversion was 1.2%.',
    solution: 'Built a custom CRM with automated lead scoring, WhatsApp follow-up sequences, and a broker portal. Integrated Google Ads and Meta Ads with lead tracking.',
    stats: [
  ...
  },
  {
    ...
    challenge: 'A bootstrapped EdTech startup needed an MVP learning platform to validate their product with 500 beta users before raising their seed round.',
    solution: 'Designed and built a full LMS with video hosting, quizzes, progress tracking, and a parent dashboard. Launched in 8 weeks and handled beta onboarding.',
    stats: [
  ...
  },
  {
    ...
    title: 'Logistics',
    challenge: 'A 120-truck fleet company running on disconnected WhatsApp groups and Excel sheets — real-time visibility into fleet location and delivery status was zero.',
    solution: 'Built a fleet tracking platform with GPS integration, driver apps, customer delivery notifications, and migrated their servers to AWS.',
    stats: [
  ...
  },
  {
    ...
    title: 'Finsphere',
    challenge: 'A SEBI-registered investment advisory firm needed a client portal for portfolio reporting and was failing their annual cybersecurity audit.',
    solution: 'Built a secure client portal with portfolio reporting, document vault, and compliance reporting. Completed a VAPT and implemented ISO 27001 controls.',
    stats: [
    ...
    <section className="project-section ">
      <div className="container">
        {caseStudiesData.map((item) => {
          ...
          return (
            <div key={item.id} className="row align-items-center project-item my-5">
              ...
              >
                <Reveal variant={isImageLeft ? fadeLeft : fadeRight} delay={0.1}>
