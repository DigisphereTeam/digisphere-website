...
import { BsExclamationTriangle, BsLightningCharge } from "react-icons/bs";
...
const FinOpsHero = () => {
  ...
  return (
    <>
              ...
              <Reveal variant={fadeUp} delay={0.1}>
                <div className="devops-hero-content">
                  ...
                  <p className="devops-description">
                    Most businesses waste 30–40% of their cloud spend. We find
                    it, fix it, and build the financial accountability systems
                    ...
                    <div className="finops-alert-left">
                      ...
                      <div>
                        ...
                        <span className="finops-alert-text">
                          EC2 eu-west-1 spiked 340% vs 7-day avg · $0.192K
                          above baseline
                        </span>
                      </div>
                    </div>
                ...
                <Reveal variant={fadeUp} delay={0.4}>
                  <div className="finops-bottom-grid">
                    <div className="finops-stat-card">
                      ...
                      <span className="finops-stat-label">
                        Avg cost reduction
                      </span>
                    </div>
      ...
      <div
        className="counter-section container-fluid px-5"
        Counter-section
