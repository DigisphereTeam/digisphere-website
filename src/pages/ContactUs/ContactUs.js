...
const API_URL =
  "https://annapurnafarms.digispheretech.in/contact-us/digisphere";
...
const ContactUs = () => {
  ...
  // Helper validation evaluations
  const cleanPhoneDigits = formData.phoneNumber.replace(/\D/g, "");
  const isPhoneInvalid = formData.phoneNumber && cleanPhoneDigits.length !== 10;
  const isProjectDetailsInvalid = formData.projectDetails && formData.projectDetails.trim().length < 20;

  const handleSubmit = async (e) => {
    e.preventDefault();

    // Guard Clause: Prevent API hit if validations are failing
    if (cleanPhoneDigits.length !== 10 || formData.projectDetails.trim().length < 20) {
      return;
    }

    setStatus("submitting");

    // Mapping state properties to what the backend expects
    const payload = {
      full_name: formData.fullName.trim(),
      company_name: formData.companyName.trim(),
      email: formData.email.trim(),
      phone_number: cleanPhoneDigits, // sends cleaned 10-digit format
            ...
            <form onSubmit={handleSubmit} className="contact-form">
              ...
              <div className="row g-4 mb-4">
                ...
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  {/* Phone Validation Warning Message */}
                  {isPhoneInvalid && (
                    <p
                      style={{
                        color: "#dc3545",
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                />
                {/* 20 Character Validation Message */}
                {isProjectDetailsInvalid && (
                  <p
                    style={{
                      color: "#dc3545",
                      fontSize: "14px",
                  ...
                  >
                    Project details must be at least 20 characters long
                    (Current: {formData.projectDetails.trim().length}/20).
                  </p>
                )}
              </div>

              <div className="form-actions">
                {/* Button blocks if rules are broken or if submitting */}
                <button
                  type="submit"
            ...
            <div className="sidebar-stack">
              ...
              <div className="info-panel timeline-panel">
                ...
                <p className="panel-subtitle">
                  After you submit, here's what happens next:
                </p>
                ...
                <ul className="step-list">
                  <li className="step-item">
                    ...
                    <span className="step-text">
                      We review your submission within 4 business hours.
                    </span>
                  </li>
                  <li className="step-item">
                    <span className="contact-step-number">2</span>
                    <span className="step-text">
                      A senior consultant calls or emails to understand your
                      needs.
                    </span>
                  </li>
                  <li className="step-item">
                    ...
                    <span className="step-text">
                      We schedule a 30-45 minute discovery call at your
                      convenience.
                    </span>
                  </li>
                  <li className="step-item">
                    ...
                    <span className="step-text">
                      You receive a detailed proposal within 2-3 business days.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="info-panel office-card">
                ...
                <div className="info-list">
                  <div className="info-item item-align-start">
                    ...
                    <span>
                      5th Floor,502, Veeramachaneni Residency, Ring Rd,
                      Ramavarapadu, Kanuru, Andhra Pradesh 520004
                    </span>
                  </div>
                  <div className="info-item">
                    <img src={phone} alt="phone" />
                    <a href="tel:+918143878627" className="link-accent">
                      +91 81438 78627
                    </a>
                  </div>
                  <div className="info-item">
                    ...
                    <a
                      href="mailto:info@digispheretech.in"
